...
if PYDANTIC_V2:
    ...
    from pydantic.class_validators import Validator as Validator  # type: ignore[no-redef]; noqa: F401
    from pydantic.error_wrappers import ErrorWrapper as ErrorWrapper  # type: ignore[no-redef]; noqa: F401
    ...
    from pydantic.fields import ModelField as ModelField  # type: ignore[no-redef,attr-defined]; noqa: F401
    ...
    from pydantic.fields import UndefinedType as UndefinedType  # type: ignore[no-redef, attr-defined]; noqa: F401
    ...
    from pydantic.typing import evaluate_forwardref as evaluate_forwardref  # type: ignore[no-redef]; noqa: F401
    from pydantic.utils import lenient_issubclass as lenient_issubclass  # type: ignore[no-redef]; noqa: F401
